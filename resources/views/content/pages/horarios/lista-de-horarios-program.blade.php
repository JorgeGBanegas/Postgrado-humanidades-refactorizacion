...
<script>
    window.onload = function() {
        ...
        document.getElementById("agregar-horario-btn").addEventListener("click", function() {
            ...
            var hini = document.getElementById("hora_program_hini").value;
            var hfin = document.getElementById("hora_program_hfin").value;
            ...
            if (dia != 0 && hini && hfin) {
                ...
                errorDiv.style.display = "block";
                document.getElementById("hora_program_hini").value = hfin;
                document.getElementById("hora_program_hfin").value = hfin;
