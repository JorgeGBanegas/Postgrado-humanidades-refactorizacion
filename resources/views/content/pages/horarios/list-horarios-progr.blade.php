<div>
    <div>
        ...
        <div style="align-items: center; display: inline-flex; justify-content: space-between;">
                ...
                <div class="container d-flex">
                    ...
                    <div class="col-4">
                        <div class="form-group" style="margin-right: 5px;">
                            <select name="hora_program_dia" required class="form-select" id="hora_program_dia">
                    ...
                    <div class="col-4">
                        <div class="form-group" style="margin-right: 5px;">
                            <input id="hora_program_hini" name="hora_program_hini" value="{{ old('hora_program_hini') }}" placeholder="Hora de inicio" type="time" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="form-group" style="margin-right: 5px;">
                            <input id="hora_program_hfin" name="hora_program_hfin" value="{{ old('hora_program_hfin') }}" placeholder="Hora de inicio" type="time" class="form-control" />
                        </div>
                    </div>
            ...
            <div>
                <input id="grupo-horario" type="hidden" value="{{$grupoHorario->grup_program_id}}">
            </div>
        </div>
            ...
            <table id="tabla-horarios" class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr id="{{ $horario->hora_program_id}}">
                        ...
                        <td>
                            <div class="d-flex">
                                <button type="button" style="margin: 2px;" class="btn btn-danger btn-sm" onclick="deleteSchedule('{{$horario->hora_program_id}}')">Eliminar</button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
...
<script>
    function addSchedule() {
        let day = document.getElementById("hora_program_dia").value;
        let hStart = document.getElementById("hora_program_hini").value;
        let hEnd = document.getElementById("hora_program_hfin").value;
        let group = document.getElementById("grupo-horario").value;
        let token = document.head.querySelector('meta[name="csrf-token"]').content;
        let route = "{{route('horarios-programas.add')}}";
        ...
        fetch(route, {
                ...
                body: JSON.stringify({
                    hora_program_dia: day,
                    hora_program_hini: hStart,
                    hora_program_hfin: hEnd,
                    grupo_horario: group
                })
            })
            .then(response => {
    ...
    function addRow(day, hStart, hEnd) {
        ...
        document.getElementById("hora_program_dia").value = "0";
        document.getElementById("hora_program_hini").value = "";
        document.getElementById("hora_program_hfin").value = "";
    }
    ...
    function deleteSchedule(idSchedule) {
        let ruta = "{{ route('horarios-programas.delete', ':idSchedule') }}";
